...
export const SPDX_LICENSE_LIST_RELEASE_DATE = '2026-07-13';

export const SPDX_LICENSE_IDS: Set<string> = new Set<string>([
  '0BSD',
  '3D-Slicer-1.0',
  'AAL',
  'Abstyles',
...
export const SPDX_DEPRECATED_LICENSE_IDS: Set<string> = new Set<string>([
  'AGPL-1.0',
  'AGPL-3.0',
  'BSD-2-Clause-FreeBSD',
  'BSD-2-Clause-NetBSD',
...
export const SPDX_EXCEPTION_IDS: Set<string> = new Set<string>([
  '389-exception',
  'Asterisk-exception',
...
export const SPDX_DEPRECATED_EXCEPTION_IDS: Set<string> = new Set<string>([
  'Nokia-Qt-exception-1.1'
]);
