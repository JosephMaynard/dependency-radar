...
describe('rangeSatisfies', () => {
  ...
  it('keeps caret/tilde/exact semantics and stays undecided on odd forms', () => {
    ...
    expect(rangeSatisfies('^0', '0.5.0')).toBe(true);
    expect(rangeSatisfies('^0', '1.0.0')).toBe(false);
    expect(rangeSatisfies('^0.x', '0.9.9')).toBe(true);
    expect(rangeSatisfies('^0.0', '0.0.5')).toBe(true);
    expect(rangeSatisfies('^0.0', '0.1.0')).toBe(false);
