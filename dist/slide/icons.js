...
function iconSvg(name, options = {}) {
    var _a, _b, _c;
    const size = (_a = options.size) !== null && _a !== void 0 ? _a : 16;
    const stroke = (_b = options.stroke) !== null && _b !== void 0 ? _b : "currentColor";
    const strokeWidth = (_c = options.strokeWidth) !== null && _c !== void 0 ? _c : 2;
    const cls = options.className ? ' class="' + options.className + '"' : "";
    const pos = (options.x !== undefined ? ' x="' + options.x + '"' : "") +
        (options.y !== undefined ? ' y="' + options.y + '"' : "");
    return ("<svg" + cls + pos + ' width="' + size + '" height="' + size + '"' +
